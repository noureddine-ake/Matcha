...
export default function HomeLayout({
  ...
  return (
    <DiscoverProvider>
      <WebSocketProvider>
        <div className="min-h-screen bg-linear-to-br from-indigo-900 via-purple-900 to-pink-800 pb-24">
          ...
          {/* Header */}
          <motion.div
            className="sticky top-0 bg-linear-to-b from-indigo-900/80 to-transparent backdrop-blur-lg border-b border-white/10 px-6 py-4 z-30"
