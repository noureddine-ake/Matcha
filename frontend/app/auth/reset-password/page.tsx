...
import { Mail, Lock, ArrowRight, Check, Loader2, Send } from "lucide-react";
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                required
                className="h-14 bg-white/10 border-white/20 text-white placeholder:text-white/50 rounded-2xl pl-12 pr-4 focus-visible:ring-2 focus-visible:ring-purple-400"
              />
            </div>
          </div>
